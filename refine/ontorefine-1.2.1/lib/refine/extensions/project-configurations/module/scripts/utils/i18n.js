/**
 * TODO: this should go in the Refine codebase. It is here temporary (for real).
 * The code is copy-pasta from the master branch of the OpenRefine. This util is expected to be in
 * the next official release of the tool.
 */
I18NUtil = {};
